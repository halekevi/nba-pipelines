...
<nav class="snav" style="position:relative;">
  ...
  <a class="snav-brand" href="index.html">
    ...
    <span class="nav-brand" style="font-family:'Inter',sans-serif;font-size:22px;font-weight:700;"><span>Prop</span><span style="font-weight:800;color:#d4af37;">Oracle</span></span>
  </a>
  <ul class="snav-links">
    <li><a href="/">Home</a></li>
