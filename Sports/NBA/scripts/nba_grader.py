...
SPORT_FILTER = 'NBA'
DEFAULT_OUTPUT = 'nba_grades.xlsx'
...
def main():
    ...
    ap.add_argument('--output', default='nba_grades.xlsx')
    ...
    print()
    print('Usage:')
    print('  Demo:     py -3.14 prop_grader.py --demo')
    print('  Template: py -3.14 prop_grader.py --template')
    print('  Grade:    py -3.14 prop_grader.py --input my_grades.csv --output grades.xlsx')
