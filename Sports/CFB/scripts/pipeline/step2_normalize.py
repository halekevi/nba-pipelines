#!/usr/bin/env python3
"""
cfb_step2_normalize.py
-----------------------
Canonical normalization layer for CFB pipeline.
Takes raw pp_cfb_scraper.py output and guarantees a stable schema
...
- cfb_player_key     : espn_athlete_id if present, else player_norm|team_abbr
...
Output: step2_normalized_cfb.csv
"""
...
def main():
    ...
    ap.add_argument("--output", default="step2_normalized_cfb.csv")
    args = ap.parse_args()
    ...
    if "espn_athlete_id" in df.columns:
        ...
        df["cfb_player_key"] = df["player_norm"] + "|" + df["team_abbr"]
    ...
    identity = ["proj_id", "player_id", "cfb_player_key", "player", "player_norm",
