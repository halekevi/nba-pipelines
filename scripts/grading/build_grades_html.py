...
.pbw-pt-header{font-family:'Bebas Neue',sans-serif;font-size:16px;letter-spacing:2px;color:var(--gold);padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,0.1);margin:16px 0 10px;text-transform:uppercase}
.pbw-tier-title{font-family:'Inter',sans-serif;font-size:12px;color:var(--muted2);letter-spacing:1px;margin:8px 0}
